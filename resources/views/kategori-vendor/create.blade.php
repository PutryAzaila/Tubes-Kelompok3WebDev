...
@section('page-subtitle', 'Tambahkan kategori vendor baru')
                ...
                <ol class="breadcrumb breadcrumb-custom">
                    <li class="breadcrumb-item">
                        <a href="{{ route('kategori-vendor.index') }}">
                            <i class="fas fa-tags me-1"></i>Kategori Vendor
                        </a>
                    </li>
                    <li class="breadcrumb-item active">Tambah Kategori</li>
                </ol>
            </nav>
            <h4><i class="fas fa-plus-circle me-2"></i>Tambah Kategori Vendor</h4>
            <p>Isi form di bawah untuk menambahkan kategori vendor baru</p>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-8">
        <div class="card-custom">
            <div class="card-header-custom">
                <h5><i class="fas fa-edit me-2"></i>Form Kategori Vendor</h5>
            </div>
                ...
                <form action="{{ route('kategori-vendor.store') }}" method="POST" id="kategoriForm">
                    ...
                    <div class="mb-4">
                        ...
                        <input 
                            ...
                            placeholder="Contoh: PT. Sumber Makmur, Telkom Indonesia, PT.Telekomunikasi"
                            required
                            autofocus
                        >
                        @error('nama_kategori')
                    ...
                    <div class="action-buttons">
                        ...
                        <a href="{{ route('kategori-vendor.index') }}" class="btn btn-cancel">
            ...
            <div class="card-body-custom">
                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <span class="badge bg-primary">PT. Sumber Makmur</span>
                        <span class="badge bg-primary">Telkom Indonesia</span>
                        <span class="badge bg-primary">PT. Telekomunikasi</span>
                        <span class="badge bg-primary">PT. Jaya Abadi</span>
                        <span class="badge bg-primary">PT. Prima Sejahtera</span>
                        <span class="badge bg-primary">PT. Mitra Solusi</span>
                    </div>
                </div>
            </div>
        </div>
