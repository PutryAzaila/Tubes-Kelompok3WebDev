...
@section('page-subtitle', 'Perbarui data perangkat')
...
<div class="container-fluid">
    ...
    <div class="page-header">
        <h4><i class="fas fa-edit me-2"></i>Edit Perangkat</h4>
        <p class="mb-0">Perbarui informasi perangkat</p>
                ...
                <div class="form-card">
                    ...
                    <div class="row g-3">
                            ...
                            >
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" 
                                        {{ old('id_kategori_perangkat', $perangkat->id_kategori_perangkat) == $category->id ? 'selected' : '' }}>
                            ...
                            <div class="status-options">
                                <div class="status-option berfungsi">
                                    <input 
                                        ...
                                        id="status_berfungsi" 
                                        value="Berfungsi"
                                        {{ old('status', $perangkat->status) == 'Berfungsi' ? 'checked' : '' }}
                                    >
                                ...
                                <div class="status-option rusak">
                                    <input 
                                        ...
                                        id="status_rusak" 
                                        value="Rusak"
                                        {{ old('status', $perangkat->status) == 'Rusak' ? 'checked' : '' }}
                                    >
                                ...
                                <div class="status-option hilang">
                                    <input 
                                        ...
                                        id="status_hilang" 
                                        value="Hilang"
                                        {{ old('status', $perangkat->status) == 'Hilang' ? 'checked' : '' }}
                                    >
                                ...
                                <div class="status-option return">
                                    <input 
                                        ...
                                        id="status_return" 
                                        value="Return"
                                        {{ old('status', $perangkat->status) == 'Return' ? 'checked' : '' }}
                                    >
                        ...
                        <div class="col-12">
                            ...
                            >{{ old('catatan_perangkat', $perangkat->catatan_perangkat) }}</textarea>
                ...
                <div class="form-card">
                    <div class="d-flex justify-content-between gap-3">
                        ...
                        <button type="submit" class="btn btn-gradient-primary">
                            <i class="fas fa-save me-2"></i>Update Perangkat
                        </button>
                    </div>
                </div>
            </form>
