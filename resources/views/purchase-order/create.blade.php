...
@section('page-subtitle', 'Buat pengajuan purchase order baru')
...
<div class="row g-3 g-lg-4">
            ...
            <div class="header-action-content">
                <div class="header-action-title">
                    ...
                    <div class="header-text">
                        <h5>Buat Purchase Order Baru</h5>
                        <p>Isi formulir untuk mengajukan purchase order</p>
                    </div>
                </div>
                <a href="{{ route('purchase-order.index') }}" class="btn btn-back">
    ...
    <!-- Form -->
    <form action="{{ route('purchase-order.store') }}" method="POST" id="poForm" class="w-100">
        @csrf
                    ...
                    <div class="card card-modern">
                        ...
                        <div class="card-body-modern">
                            ...
                            <button type="submit" class="btn btn-submit-modern">
                                <i class="fas fa-paper-plane me-2"></i>Ajukan PO
                            </button>
                        </div>
                    </div>
                </div>
